    ...
    <Row gutter={24} type="flex">
      <Col {...topColResponsiveProps}>
        <ChartCard
          ...
          title={
            <FormattedMessage
              id="BLOCK_NAME.analysis.total-sales"
          ...
          action={
            <Tooltip
              title={
                <FormattedMessage
                  id="BLOCK_NAME.analysis.introduce"
          ...
          footer={
            <Field
              label={
                <FormattedMessage
                  id="BLOCK_NAME.analysis.day-sales"
      ...
      <Col {...topColResponsiveProps}>
        <ChartCard
          ...
          title={
            <FormattedMessage
              id="BLOCK_NAME.analysis.payments"
