              ...
              },
              {
                ...
                component: __IS_BROWSER
                  ? _dvaDynamic({
                      app: require('@tmp/dva').getApp(),
                      models: () => [
                        import(/* webpackChunkName: 'p__dashboard___DashboardAnalysis__model.tsx' */ 'D:/test/TypeScript/antd/antd-pro-with-hooks/src/pages/dashboard/_DashboardAnalysis/model.tsx').then(
                          m => {
                            return { namespace: 'model', ...m.default };
                          },
                        ),
              ...
              },
              {
                ...
                component: __IS_BROWSER
                  ? _dvaDynamic({
                      app: require('@tmp/dva').getApp(),
                      models: () => [
                        import(/* webpackChunkName: 'p__dashboard___DashboardWorkplace__model.ts' */ 'D:/test/TypeScript/antd/antd-pro-with-hooks/src/pages/dashboard/_DashboardWorkplace/model.ts').then(
                          m => {
                            return { namespace: 'model', ...m.default };
                          },
                        ),
              ...
              },
              {
                ...
                component: __IS_BROWSER
                  ? _dvaDynamic({
                      app: require('@tmp/dva').getApp(),
                      models: () => [
                        import(/* webpackChunkName: 'p__dashboard___DashboardMonitor__model.ts' */ 'D:/test/TypeScript/antd/antd-pro-with-hooks/src/pages/dashboard/_DashboardMonitor/model.ts').then(
                          m => {
                            return { namespace: 'model', ...m.default };
                          },
                        ),
